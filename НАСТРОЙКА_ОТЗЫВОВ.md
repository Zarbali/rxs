...
Политика RLS блокирует чтение для авторизованных. Исправление:

1. Откройте [supabase.com/dashboard](https://supabase.com/dashboard) и войдите
2. Выберите свой проект (RXS)
3. В левом меню нажмите **SQL Editor**
4. Нажмите **New query** (Новый запрос)
5. Вставьте **только** этот код (без создания таблицы):
...
6. Нажмите зелёную кнопку **Run** (или Ctrl+Enter)
7. Должно появиться «Success»
8. Обновите страницу отзывов на сайте (Ctrl+Shift+R)
